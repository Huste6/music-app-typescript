...
router.post("/create", upload.single("avatar"), uploadCloud_middleware_1.uploadSingle, controller.createPost);
...
router.post("/edit/:idSinger", upload.single("avatar"), uploadCloud_middleware_1.uploadSingle, controller.editPOST);
